...
//name tf selected
if collision_rectangle(name_posx, name_posy, name_posx+name_width, name_posy+name_height, obj_mouse, false, false)
{
...
//price tf selected
if collision_rectangle(price_posx, price_posy, price_posx+price_width, price_posy+price_height, obj_mouse, false, false)
{
	if(mouse_check_button_pressed(mb_left))
	{

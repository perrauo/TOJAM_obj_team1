...
//stack containing the tracks to move the train forward on the track (contains obj_map_track s)
global.stack_traj_front = ds_stack_create(); 
//stack containing the tracks to move the train backward on the track
global.stack_traj_back = ds_stack_create(); 
